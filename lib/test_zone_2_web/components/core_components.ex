defmodule TestZone2Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestZone2Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestZone2Web.Gettext, "errors", msg, opts)
    end
  end
